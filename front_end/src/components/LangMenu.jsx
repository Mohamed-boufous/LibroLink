...
export default function LangMenu() {
  ...
  return (
    <DropdownMenu>
      <DropdownMenuTrigger className="flex w-16">
        {Lang === "ENG" && <img className="mr-2 size-8" src={UKicon} alt="eng" />}
        {Lang === "FR" && <img className="mr-2 size-8" src={FRicon} alt="eng" />}
        {Lang === "AR" && <img className="mr-2 size-8" src={MRicon} alt="eng" />}
        {Lang}
      </DropdownMenuTrigger>
      <DropdownMenuContent>
        <DropdownMenuItem>
