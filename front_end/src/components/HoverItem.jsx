...
const VisitCounter = ({ visitCount }) => {
  return (
    <div style={{ position: 'absolute', top: 0, right: 0, left: 0, bottom: 0, backgroundColor: 'rgba(255, 255, 255, 0.8)', padding: '5px' }}>
      <h4 className='title'>title</h4>
      <p className='gender'>genre exemple</p>
      <div className='star-div'>
        <svg className="star-svg" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/2000/xlink" width="21px" height="20px">
      ...
      <div className='langague-div'>
        <img src={imageworld} alt="" className='svg'/>
        <span>kfkfkfkf</span>
      </div>
